                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse ($branches as $row)
                        <tr>
                            ...
                            <td class="px-4 py-2 text-right text-gray-700">{{ $row['avg_time_to_accept_minutes'] !== null ? $row['avg_time_to_accept_minutes'].' '.__('min') : '—' }}</td>
                            <td class="px-4 py-2 text-right text-gray-700">{{ $row['avg_prep_time_minutes'] !== null ? $row['avg_prep_time_minutes'].' '.__('min') : '—' }}</td>
                            <td class="px-4 py-2 text-right text-gray-700">{{ $row['avg_delivery_time_minutes'] !== null ? $row['avg_delivery_time_minutes'].' '.__('min') : '—' }}</td>

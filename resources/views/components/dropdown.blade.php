...
@php
// 'top' opens the panel above the trigger instead of below it — needed for
// triggers pinned near the bottom of the viewport (the sidebar's account
// menu), where opening downward pushes the panel off-screen and forces a
// scroll to reach it.
